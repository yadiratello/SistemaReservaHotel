...
public class DReserva {
    ...
    public DReserva(int idreserva, int idhabitacion, int idcliente, int idtrabajador, String tipo_reserva, Date fecha_reserva, Date fecha_ingresa, Date fecha_salida, double costo_alojamiento, String estado) {
